...
function Home() {
    return ( <
        ...
        Link to = 'invoices'
        style = {
            { color: 'red' } } > INVOICES < /Link> 
        or in < Link to = 'todoListRecoil'
        style = {
            { color: 'red' } } > PURCHASE ORDER < /Link> on the Navbar.</li >
        <
        /li>  <
        li > Sorry this is an demo, some options this in Construction < /li> <
        li > If want can download the program in my repository <
        a href = "https://github.com/eliezerpolidor/System-Invocesing-Customers.git"
        target = "_blank" > https: //github.com/eliezerpolidor/System-Invocesing-Customers.git</a> &nbsp; | &nbsp;
        <
        /li> <
        /ul> <
        /div>
